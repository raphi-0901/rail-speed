...
export class OebbRegioProvider implements SpeedProvider {
    readonly name = 'OEBB-Regio';
    ...
    fetch(): { promise: Promise<ProviderResult>; cancel: () => void } {
        const {promise, cancel} = this._http.fetchText('https://railnetregio.oebb.at/api/speed', {
